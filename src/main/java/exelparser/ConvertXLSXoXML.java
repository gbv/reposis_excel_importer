...
public class ConvertXLSXoXML {
 
    private static void convertSelectedSheetInXLXSFileToXML(File xlsxFile, int sheetIdx) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        File myFile = new File("/home/sven/Apps/GrassArchivDaten.xlsx");
        int sheetIdx = 0; // 0 for first sheet
 
        convertSelectedSheetInXLXSFileToXML(myFile, sheetIdx);
    }
}
